...
const NotFound = () => {
  ...
  return (
    <div className="h-screen w-screen flex flex-col justify-center align-center items-center bg-black mx-auto">
      <div className="bg-gray-800 rounded-md h-[90%] w-[90%] overflow-auto ">
        ...
        <p
          className="text-white whitespace-pre-line p-2 font-bold text-3xl 
        ...
        <p className="text-red-500 whitespace-pre-line pb-2 font-bold text-4xl mt-10 italic p-2 h-1/3">
