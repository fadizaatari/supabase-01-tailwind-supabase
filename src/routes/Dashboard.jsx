...
const Dashboard = () => {
  ...
  return (
    <div>
      <div>
        <Header />
        <div className=" top-0 left-0 h-screen w-screen flex justify-center items-center p-10 dark:bg-black bg-white text-white rounded-md text-lg">
          <div className="bg-MyGray  p-6 rounded-md shadow-md text-white">
